...
export const WhatsCommand: MiddlewareFn & Partial<Command<'whats'>> = async ctx => {
    if (!ctx.match) {
...
WhatsCommand.command = 'whats';
WhatsCommand.description = 'Gera um link para mandar mensagem no WhatsApp sem precisar adicionar o contato';
